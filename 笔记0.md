...
enum Season0 {//类
    ...
    // 3. 如果有多个常量(对象)， 使用 ,号间隔即可;如果有多个常量(对象)， 使用 ,号间隔即可;如果有多个常量(对象)， 使用 ,号间隔即可;如果有多个常量(对象)， 使用 ,号间隔即可;如果有多个常量(对象)， 使用 ,号间隔即可;如果有多个常量(对象)， 使用 ,号间隔即可;如果有多个常量(对象)， 使用 ,号间隔即可;如果有多个常量(对象)， 使用 ,号间隔即可;如果有多个常量(对象)， 使用 ,号间隔即可;如果有多个常量(对象)， 使用 ,号间隔即可;
